...
class LikeButton
{
    public static function render($post_id, $smallBtn = false)
    {
        ...
        ?>
        <button
            class=" <?php echo $smallBtn ? 'micro' : 'small_text' ?> flat text_icon_btn like-button <?php echo esc_attr($disabled_class); ?> <?php echo esc_attr($my_likes); ?>">
            <img class="like-icon"
            ...
            <span class="card_caption_text like-count"
                style="display: <?php echo $likes > 0 ? 'flex' : 'none'; ?>"><?php echo esc_html($likes); ?></span>
        </button>
        <?php
    }
}